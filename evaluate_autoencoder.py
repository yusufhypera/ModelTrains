...
from models.autoencoder import AutoEncoderFER
...
model = AutoEncoderFER().to(device)
model.load_state_dict(torch.load("autoencoder_fer_denoising.pth", map_location=device))
model.eval()
